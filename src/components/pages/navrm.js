...
const handleRegistrationChange = (e) => {
  ...
  return (
<>
<Navbar expanded={expanded} className="navbar navbar-expand-md  mx-2 what-card-navbar" style={{ backgroundColor: '#121661', position: 'fixed', zIndex: '2', width: '98.5%', top: '0.4rem', borderRadius:'0' }}>
        ...
        >
          ...
          <Navbar.Collapse className="justify-content-end text-center" id="navbarNav"  style={{transition:'1s ease', zIndex: 999}}>
